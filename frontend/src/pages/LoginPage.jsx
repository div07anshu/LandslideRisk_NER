    ...
    return (
        <div className="min-h-screen bg-slate-100 flex items-center justify-center p-4">
            ...
            <div className="w-full max-w-5xl bg-white rounded-2xl shadow-xl overflow-hidden grid md:grid-cols-2">
                ...
                {/* LEFT SIDE */}
                <div className="hidden md:flex bg-[#112D4E] text-white p-10 flex-col justify-between">
                    ...
                    <div>
                        ...
                        <div className="mt-16">
                            ...
                            <p className="mt-5 text-slate-300 leading-relaxed">
                                AI-based landslide risk monitoring and early
                                warning system for the North Eastern Region of India.
                            </p>
                        </div>
                    </div>
                ...
                <div className="p-8 sm:p-12">
                    ...
                    <div className="flex md:hidden items-center gap-3 mb-10">
                        ...
                        <div>
                            <h1 className="font-bold text-[#112D4E]">
                                LandslideRisk NER
                            </h1>
                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <div className="mt-8 p-4 bg-slate-50 border border-slate-200 rounded-lg text-xs text-slate-500">
                            ...
                            <br />
                            Authorized users can sign in to access
                            landslide risk information and alerts.
                        </div>
